...
/// <summary>
/// Summary description for TenantTableInfo
/// </summary>
public class TenantTableInfo
{
    private string TableName;
    private List<string> FieldNames;
    private List<string> FeildValues;

    public TenantTableInfo()
    {
        //
    ...
    public string TableNameProperty { get; set; }
    public List<string> FieldNamesProperty { get; set; }
    public List<string> FieldValuesProperty { get; set; }
}